export const WorkPageHeadelineChooseBtns = [
  {
    title: "Work",
    fontSize: "180px",
    btns: [
...
export const WorkPageCardItens = [
  {
    workImg:
  ...
  {
    workImg:
      "https://videinfra.com/assets/images/media/works/transact-bank/preview-list@xxxl.webp",
